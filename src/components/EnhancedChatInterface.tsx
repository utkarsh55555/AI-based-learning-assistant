...
import { Send, Sparkles, Camera, Volume2, ThumbsUp, ThumbsDown, Copy, Mic, MicOff } from "lucide-react";
...
const mockResponses = [
  ...
  "I can help you understand this better. Here's a breakdown:",
  "That's an interesting topic! Let me provide some context:",
  "Let me walk you through this step by step:",
  "Excellent! Here's how we can approach this problem:",
];
...
export function EnhancedChatInterface() {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      // Call API
      const response = await tutorAPI.chat(input, conversationHistory);
        ...
        {imageUploadMode && (
          ...
          >
            <div className="text-center">
              ...
              <Button size="sm" variant="outline" className="hover:bg-white/10">
                Choose Image
              </Button>
            </div>
          </motion.div>
